...
javatest() {
    git clone -b test/side-service-issues-1050-preserve-recurring-override-participation https://github.com/vttranlina/twake-calendar-integration-tests.git it-tests ||  exit 1
    cd it-tests || exit 1
